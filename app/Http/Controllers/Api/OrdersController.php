...
class OrdersController extends Controller
{
 ...
 public function store(Request $request){
    ...
    foreach ($items as $key => $item){
      $directPaymentRequest->addItem("00$key",$item['name'],$item['quantidade'],$item['price']);
    }
    ...
    try {
        $credentials = \PagSeguro\Configuration\Configure::getAccountCredentials(); // getApplicationCredentials()
