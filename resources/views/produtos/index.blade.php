            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="GET" action="{{ url('/produtos') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($produtos as $item)
                                    <tr>
                                        ...
                                        @if(!empty($item->photo))
                                        <td><img src="/images/produtos-mini/{{$item->photo}}" class="img-thumbnail"></td>
                                        @else
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/produtos' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-danger btn-xs" title="Delete Produto" onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
